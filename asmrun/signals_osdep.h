...
/****************** AMD64, Linux */
  ...
  #define CONTEXT_EXNPTR_OFFSET (context->uc_mcontext.gregs[REG_R14])
...
/****************** AMD64, MacOSX */
  ...
  #define CONTEXT_EXNPTR_OFFSET (CONTEXT_STATE.CONTEXT_REG(r14))
...
/****************** ARM, Linux */
  ...
  #define CONTEXT_EXNPTR_OFFSET (context->uc_mcontext.arm_fp)
...
/****************** ARM64, Linux */
  ...
  #define CONTEXT_EXNPTR_OFFSET (context->uc_mcontext.regs[26])
...
/****************** AMD64, OpenBSD */
 ...
 #define CONTEXT_EXNPTR_OFFSET (context->sc_r14)
...
/****************** PowerPC, MacOS X */
  ...
  #define CONTEXT_EXNPTR_OFFSET (CONTEXT_STATE.CONTEXT_REG(r29))
...
/****************** PowerPC, ELF (Linux) */
  ...
  #define CONTEXT_EXNPTR_OFFSET (context->regs->gpr[29])
...
/****************** PowerPC, BSD */
  ...
  #define CONTEXT_EXNPTR_OFFSET (context->sc_frame.fixreg[29])
...
/****************** SPARC, Solaris */
  ...
  #define CONTEXT_EXNPTR_OFFSET (SPARC_L_REG(5))
